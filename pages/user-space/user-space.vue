  ...
  <view >
    ...
    <view class="flex align-center" style="height: 100rpx">
      <view
        ...
        :key="index"
        :class="
          index === tabIndex ? 'font-lg font-weight-bold text-main' : 'font-md'
        "
    ...
    <uni-popup ref="popup" type="top">
      ...
      <view
        ...
        class="flex align-center justify-center font-md py-2"
        hover-class="bg-light"
        @click="openChat"
      >
    ...
    getList() {
      ...
      this.$H
        ...
        .then((res) => {
          ...
          this.tabBars[index].list = isrefresh
            ? [...list]
            : [...this.tabBars[index].list, ...list]
          this.tabBars[index].loadmore =

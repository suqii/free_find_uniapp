...
var __uniConfig = {
  pages: [
    ...
    'pages/my/my',
    'pages/search/search',
    'pages/add-input/add-input',
    'pages/topic-nav/topic-nav',
    'pages/topic-detail/topic-detail',
    'pages/user-list/user-list',
    'pages/user-chat/user-chat',
    'pages/detail/detail',
    'pages/user-set/user-set',
    'pages/user-password/user-password',
    'pages/user-email/user-email',
    'pages/user-userinfo/user-userinfo',
    'pages/user-feedback/user-feedback',
    'pages/about/about',
    'pages/login/login',
    'pages/user-space/user-space',
    'pages/user-safe/user-safe',
    'pages/user-phone/user-phone',
...
var __uniRoutes = [
  ...
  },
  {
    ...
    meta: {},
    window: { navigationBarTitleText: '话题分类' },
  },
  {
    path: '/pages/topic-detail/topic-detail',
    meta: {},
    window: {
      titleNView: { type: 'transparent', buttons: [{ type: 'menu' }] },
    },
  },
  {
  ...
  },
  {
    ...
    meta: {},
    window: { titleNView: { buttons: [{ type: 'menu', float: 'right' }] } },
  },
  {
    path: '/pages/user-set/user-set',
    meta: {},
    window: { navigationBarTitleText: '设置' },
  },
  {
  ...
  },
  {
    ...
    meta: {},
    window: { navigationBarTitleText: '绑定邮箱' },
  },
  {
    path: '/pages/user-userinfo/user-userinfo',
    meta: {},
    window: { navigationBarTitleText: '修改资料' },
  },
  {
    path: '/pages/user-feedback/user-feedback',
    meta: {},
    window: { navigationBarTitleText: '意见反馈' },
  },
  {
    path: '/pages/about/about',
    meta: {},
    window: { navigationBarTitleText: '关于社区' },
  },
  { path: '/pages/login/login', meta: {}, window: { titleNView: false } },
  {
  ...
  },
  {
    ...
    meta: {},
    window: { navigationBarTitleText: '账号与安全' },
  },
  {
    path: '/pages/user-phone/user-phone',
    meta: {},
    window: { navigationBarTitleText: '绑定手机号' },
  },
  {
